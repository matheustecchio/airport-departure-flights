...
def read_csv():
    csv_busy_times = Path("./data/shannon/busy_times.csv")
    csv_flights = Path("./data/shannon/flights_processed.csv")
...
def export_html(df_html_busy_times, df_html_flights):
    html_busy_times = Path("./data/shannon/busy_times.html")
    html_flights = Path("./data/shannon/flights_processed.html")
